...
public class DelayRabbitConfig {
    ...
    public Queue delayOrderQueue(){
        ...
        // x-dead-letter-exchange 声明了死信队列里的死信转发到消息处理交换机的名称
     ...
     * 这是一个完整的匹配.如果一个队列绑定到该交换机上要求路由键"dog",则只要被标记为"dog"的消息才被转发,
     ...
     * 符号"#"匹配一个词或多个词,符号"*"匹配一个词.因此"audit.#"能够匹配到"audit.irs.corporate".
    ...
    @Bean Binding orderBinding(){
        // 如果要让延时队列之间有关联,这里的routingKey 和绑定的交换机很关键
